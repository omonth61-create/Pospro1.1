...
const POSPage: React.FC = () => {
  ...
  const handleFinishCheckout = async (customerName: string, paymentMethod?: string, paidAmount?: number) => {
    ...
    try {
      ...
      await indexdbTransaksi.create(getTotal(), items, customerName, paymentMethod, paidAmount);
    } catch (error) {
      console.error(error);
